...
本来想看懂redis与数据库双写一致性问题，太复杂了，太绕了，没试过，整蒙圈了，又是先删缓存再更新数据库，又是先更新数据库再删缓存，完了这两种都有弊端，没有确切的答案。挣扎了一番，我决定以后再看！先po文章链接：[链接](https://www.cnblogs.com/rjzheng/p/9041659.html)