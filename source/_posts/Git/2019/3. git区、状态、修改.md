...
git reset (--soft) HEAD^ 回退到已修改状态，修改还在工作区
...
#### [恢复版本](https://blog.csdn.net/yxlshk/article/details/79944535)
...
##### [revert 多个 commit](https://blog.gaoqixhb.com/p/5bc6a082db87521194964220) 
...
##### [revert mr](https://blog.csdn.net/runatworld/article/details/108247382)
...
第一个是主分支，第二个是功能分支，revert 时需要标注主线，主线的内容将会保留，而另一条分支的内容将被 revert
